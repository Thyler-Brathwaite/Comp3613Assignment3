...
class Student(User, Subject):
    ...
    activityhistories = db.relationship(
        'ActivityHistory', 
        backref='student', 
        lazy=True, 
        cascade="all, delete-orphan"
    ...
    def get_total_hours(self):
        return sum(log.hours for log in self.loggedhours if log.status == 'approved')
    ...
    def check_and_notify_accolades(self):
        current_accolades = set(self.accolades())
